...
docker挂载命令：docker run -it -v E:\vscode\vscode_c++\Compilation_principle\ex3:/coursegrader frankd35/demo:v3
目录结构：
/bin		可执行文件 + 库文件
/build		构建项目的文件
/include	头文件
...
riscv32-unknown-linux-gnu-gcc ./output.s  sylib-riscv-linux.a -o ./test.exe
